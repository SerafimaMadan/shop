...
<script type="text/javascript" src="js/jquery-1.8.2.min.js"></script> <!--библиотека java script-->
...
<div id="block-content"><!--все товары-->
    <div id="block-sorting">
       ...
       <ul id="options-list">
           ...
           <li>Сортировка:</li>
           <li ><a id="selector-sort"> <?php echo $sort_name; ?> </a>
        <ul id="sorting-list">
            <li><a href="index.php?sort=price-asc">по цене</a></li>
            <li><a href="index.php?sort=popular">по популярности</a></li>
...
if ($temp[0]>0){
    ...
    list($result, $num_rows) = db_query($con,"SELECT * FROM table_producrs WHERE visible='1'ORDER BY $sorting $qury_start_num"); /*ORDER BY это сортировка по заданной переменной*/
...
';
    ...
    <ul id="block-product-list">
        ...
        $con=mysqli_connect("localhost", "admin", "12345", "db_shop");
        $result = mysqli_query($con,"SELECT * FROM table_producrs WHERE visible='1' ORDER BY $sorting $qury_start_num"); /*ORDER BY это сортировка по заданной переменной*/
